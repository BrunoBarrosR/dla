...
public class Desafio_ControleTarefasDinamicas {
...
//        tarefas.push(tarefa);
    ...
    public static void aumentarPrioridade(String tarefaAlterada) {
        ...
        if(indexAtual > 0) {
            ...
            String tempIndexPosterior = listaTarefas.get(indexPosterior);

            listaTarefas.set(indexPosterior, tarefaAlterada);
            listaTarefas.set(indexAtual, tempIndexPosterior);
    ...
    public static void diminuirPrioridade(String tarefaAlterada) {
        ...
        if(indexAtual < listaTarefas.size() + 1) {
            ...
            System.out.println("Prioridade da tarefa " + tarefaAlterada + " foi diminuida!");
            for (String tarefa : listaTarefas) {
                System.out.println(tarefa);
            }
